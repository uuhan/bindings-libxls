...
extern void xls_showROW(st_row_data* row);
extern void xls_showColinfo(st_colinfo_data* col);
extern void xls_showCell(st_cell_data* cell);
extern void xls_showFont(st_font_data* font);
extern void xls_showXF(XF8* xf);
extern void xls_showFormat(st_format_data* format);
extern char* xls_getfcell(xlsWorkBook* pWB,st_cell_data* cell);
